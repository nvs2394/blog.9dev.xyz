...
_Avoid inconsistencies when using verbs for naming functions and stick to using the same verbs for the same actions._
...
_To avoid any confusion, make sure to use nouns and think before adding an extra word to the name._

_Does it add any value, or does it make the meaning fuzzier?_
